 ...
 *
 ******************************************************************************/
#ifndef SWIFT_DAB_BLACK_HOLES_PARAMETERS_H
#define SWIFT_DAB_BLACK_HOLES_PARAMETERS_H

/* Configuration file */
#include "config.h"

/**
 * @file DAB/black_holes_parameters.h
 * @brief Parameters of the DAB black holes
...
#endif /* SWIFT_DAB_BLACK_HOLES_PARAMETERS_H */
